...
# initialize keys
keyL = Pin(17, Pin.IN, Pin.PULL_UP)
keyR = Pin(32, Pin.IN, Pin.PULL_UP)
keyU = Pin(33, Pin.IN, Pin.PULL_UP)
keyD = Pin(27, Pin.IN, Pin.PULL_UP)
keyA = Pin(34, Pin.IN, Pin.PULL_UP)
keyB = Pin(35, Pin.IN, Pin.PULL_UP)
keySelect = Pin(39, Pin.IN, Pin.PULL_UP)
keyStart = Pin(23, Pin.IN, Pin.PULL_UP)
...
class Ball(object):
    ...
    #            # Release frozen ball after 2 seconds
            if not keyA.value():
                ...
                return
        if ticks_diff(ticks_ms(), self.lastmoved) < 10:
            return
        self.lastmoved = ticks_ms()
